# Documentation: tensorflow_v2/notebooks/3_NeuralNetworks/recurrent_network.ipynb

## File Metadata

- **File Path**: `tensorflow_v2/notebooks/3_NeuralNetworks/recurrent_network.ipynb`
...
This file is located at `tensorflow_v2/notebooks/3_NeuralNetworks/recurrent_network.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v2/notebooks/3_NeuralNetworks/recurrent_network.ipynb
```
