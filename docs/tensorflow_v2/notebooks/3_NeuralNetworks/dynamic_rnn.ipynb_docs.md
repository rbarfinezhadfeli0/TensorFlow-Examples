# Documentation: tensorflow_v2/notebooks/3_NeuralNetworks/dynamic_rnn.ipynb

## File Metadata

- **File Path**: `tensorflow_v2/notebooks/3_NeuralNetworks/dynamic_rnn.ipynb`
...
This file is located at `tensorflow_v2/notebooks/3_NeuralNetworks/dynamic_rnn.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v2/notebooks/3_NeuralNetworks/dynamic_rnn.ipynb
```
...
rnn, dataset, training, forward pass, gradient, neural network, lstm, accuracy, loss, softmax, tensorflow, optimizer
