# Documentation: tensorflow_v2/notebooks/5_DataManagement/image_transformation.ipynb

## File Metadata

- **File Path**: `tensorflow_v2/notebooks/5_DataManagement/image_transformation.ipynb`
- **File Size**: 2503084 bytes
- **File Type**: .ipynb
...
```bash
jupyter notebook tensorflow_v2/notebooks/5_DataManagement/image_transformation.ipynb
```
...
rnn, dataset, training, relu, lstm, gan, loss, tensorflow, cnn
