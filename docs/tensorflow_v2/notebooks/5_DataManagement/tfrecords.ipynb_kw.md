# Keyword Map: tensorflow_v2/notebooks/5_DataManagement/tfrecords.ipynb

## File Path and Links

- **Original Source**: [tensorflow_v2/notebooks/5_DataManagement/tfrecords.ipynb](../../../../tensorflow_v2/notebooks/5_DataManagement/tfrecords.ipynb)
- **Documentation**: [tensorflow_v2/notebooks/5_DataManagement/tfrecords.ipynb_docs.md](tfrecords.ipynb_docs.md)
...
- **File**: [tensorflow_v2/notebooks/5_DataManagement/tfrecords.ipynb](../../../../tensorflow_v2/notebooks/5_DataManagement/tfrecords.ipynb)
- **Documentation**: [tensorflow_v2/notebooks/5_DataManagement/tfrecords.ipynb_docs.md](tfrecords.ipynb_docs.md)
