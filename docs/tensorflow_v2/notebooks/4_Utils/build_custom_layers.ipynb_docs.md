# Documentation: tensorflow_v2/notebooks/4_Utils/build_custom_layers.ipynb

## File Metadata

- **File Path**: `tensorflow_v2/notebooks/4_Utils/build_custom_layers.ipynb`
...
This file is located at `tensorflow_v2/notebooks/4_Utils/build_custom_layers.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v2/notebooks/4_Utils/build_custom_layers.ipynb
```
...
activation, dataset, training, forward pass, gradient, relu, neural network, accuracy, loss, mnist, softmax, tensorflow, optimizer
