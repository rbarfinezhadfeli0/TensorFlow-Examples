# Documentation: tensorflow_v2/notebooks/4_Utils
...
- [build_custom_layers.ipynb](./build_custom_layers.ipynb_docs.md): Jupyter notebook with interactive code examples
- [save_restore_model.ipynb](./save_restore_model.ipynb_docs.md): Jupyter notebook with interactive code examples
- [tensorboard.ipynb](./tensorboard.ipynb_docs.md): Jupyter notebook with interactive code examples
