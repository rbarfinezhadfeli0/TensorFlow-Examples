# Documentation: tensorflow_v2/notebooks/4_Utils/save_restore_model.ipynb

## File Metadata

- **File Path**: `tensorflow_v2/notebooks/4_Utils/save_restore_model.ipynb`
- **File Size**: 16315 bytes
- **File Type**: .ipynb
...
This file is located at `tensorflow_v2/notebooks/4_Utils/save_restore_model.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v2/notebooks/4_Utils/save_restore_model.ipynb
```
...
- [tensorboard.ipynb](tensorboard.ipynb_docs.md)
...
activation, dataset, training, forward pass, regression, gradient, relu, neural network, accuracy, loss, mnist, softmax, tensorflow, optimizer
