# Documentation: tensorflow_v2/notebooks/2_BasicModels
...
- [gradient_boosted_trees.ipynb](./gradient_boosted_trees.ipynb_docs.md): Jupyter notebook with interactive code examples
...
- [word2vec.ipynb](./word2vec.ipynb_docs.md): Jupyter notebook with interactive code examples
