# Documentation: tensorflow_v2/notebooks/6_Hardware
...
- [multigpu_training.ipynb](./multigpu_training.ipynb_docs.md): Jupyter notebook with interactive code examples
