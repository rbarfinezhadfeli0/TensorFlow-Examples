...
- [README.md](./README.md_docs.md): Overview and guide for this folder
...
- [examples](../examples/doc.md): Python script versions of the examples.
- [notebooks](../notebooks/doc.md): Jupyter notebook versions of the examples.
- [resources](../resources/doc.md): Resource files including images and assets.
- [tensorflow_v1](../tensorflow_v1/doc.md): TensorFlow 1.x specific examples and code.
- [tensorflow_v2](doc.md): TensorFlow 2.x specific examples and code.
