# Documentation: examples/5_DataManagement/build_an_image_dataset.py

## File Metadata

- **File Path**: `examples/5_DataManagement/build_an_image_dataset.py`
...
This file is located at `examples/5_DataManagement/build_an_image_dataset.py` within the TensorFlow Examples repository.
...
```bash
python examples/5_DataManagement/build_an_image_dataset.py
```
