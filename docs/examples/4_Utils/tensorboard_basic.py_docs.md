# Documentation: examples/4_Utils/tensorboard_basic.py

## File Metadata

- **File Path**: `examples/4_Utils/tensorboard_basic.py`
...
This file is located at `examples/4_Utils/tensorboard_basic.py` within the TensorFlow Examples repository.
...
__future__, training, gradient, accuracy, loss, mnist, print_function, tensorflow, input_data, tensorflow.examples.tutorials.mnist, tensorflow, optimizer, softmax
