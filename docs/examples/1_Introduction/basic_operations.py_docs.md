# Documentation: examples/1_Introduction/basic_operations.py

## File Metadata

- **File Path**: `examples/1_Introduction/basic_operations.py`
...
This file is located at `examples/1_Introduction/basic_operations.py` within the TensorFlow Examples repository.
...
```bash
python examples/1_Introduction/basic_operations.py
```
