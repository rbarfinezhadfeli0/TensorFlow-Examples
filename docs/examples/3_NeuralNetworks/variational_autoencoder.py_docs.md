# Documentation: examples/3_NeuralNetworks/variational_autoencoder.py

## File Metadata

- **File Path**: `examples/3_NeuralNetworks/variational_autoencoder.py`
...
This file is located at `examples/3_NeuralNetworks/variational_autoencoder.py` within the TensorFlow Examples repository.
...
```bash
python examples/3_NeuralNetworks/variational_autoencoder.py
```
