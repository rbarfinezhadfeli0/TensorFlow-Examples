# Documentation: examples/3_NeuralNetworks/dcgan.py

## File Metadata

- **File Path**: `examples/3_NeuralNetworks/dcgan.py`
...
This file is located at `examples/3_NeuralNetworks/dcgan.py` within the TensorFlow Examples repository.
...
```bash
python examples/3_NeuralNetworks/dcgan.py
```
