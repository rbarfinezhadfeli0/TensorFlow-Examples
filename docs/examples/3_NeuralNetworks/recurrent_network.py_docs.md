# Documentation: examples/3_NeuralNetworks/recurrent_network.py

## File Metadata

- **File Path**: `examples/3_NeuralNetworks/recurrent_network.py`
...
This file is located at `examples/3_NeuralNetworks/recurrent_network.py` within the TensorFlow Examples repository.
