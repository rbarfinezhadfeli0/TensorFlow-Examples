# Documentation: examples/3_NeuralNetworks/neural_network_raw.py

## File Metadata

- **File Path**: `examples/3_NeuralNetworks/neural_network_raw.py`
...
This file is located at `examples/3_NeuralNetworks/neural_network_raw.py` within the TensorFlow Examples repository.
...
```bash
python examples/3_NeuralNetworks/neural_network_raw.py
```
