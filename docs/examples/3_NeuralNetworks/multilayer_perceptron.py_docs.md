# Documentation: examples/3_NeuralNetworks/multilayer_perceptron.py

## File Metadata

- **File Path**: `examples/3_NeuralNetworks/multilayer_perceptron.py`
...
This file is located at `examples/3_NeuralNetworks/multilayer_perceptron.py` within the TensorFlow Examples repository.
...
dataset, __future__, training, multilayer_perceptron, out_layer, neural network, accuracy, loss, mnist, print_function, tensorflow, input_data, tensorflow.examples.tutorials.mnist, tensorflow, optimizer, softmax
