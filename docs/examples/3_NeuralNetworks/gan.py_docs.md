# Documentation: examples/3_NeuralNetworks/gan.py

## File Metadata

- **File Path**: `examples/3_NeuralNetworks/gan.py`
...
This file is located at `examples/3_NeuralNetworks/gan.py` within the TensorFlow Examples repository.
...
```bash
python examples/3_NeuralNetworks/gan.py
```
