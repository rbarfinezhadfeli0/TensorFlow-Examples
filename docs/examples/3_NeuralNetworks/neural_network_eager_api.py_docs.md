# Documentation: examples/3_NeuralNetworks/neural_network_eager_api.py

## File Metadata

- **File Path**: `examples/3_NeuralNetworks/neural_network_eager_api.py`
...
This file is located at `examples/3_NeuralNetworks/neural_network_eager_api.py` within the TensorFlow Examples repository.
...
```bash
python examples/3_NeuralNetworks/neural_network_eager_api.py
```
