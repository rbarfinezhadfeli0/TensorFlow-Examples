# Documentation: examples/2_BasicModels/word2vec.py

## File Metadata

- **File Path**: `examples/2_BasicModels/word2vec.py`
...
This file is located at `examples/2_BasicModels/word2vec.py` within the TensorFlow Examples repository.
...
```bash
python examples/2_BasicModels/word2vec.py
```
