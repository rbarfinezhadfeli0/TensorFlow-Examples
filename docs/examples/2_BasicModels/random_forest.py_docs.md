# Documentation: examples/2_BasicModels/random_forest.py

## File Metadata

- **File Path**: `examples/2_BasicModels/random_forest.py`
...
This file is located at `examples/2_BasicModels/random_forest.py` within the TensorFlow Examples repository.
...
```bash
python examples/2_BasicModels/random_forest.py
```
...
os, __future__, training, mnist, it., accuracy, loss, id, tensor_forest, print_function, tensorflow, input_data, resources, tensorflow.contrib.tensor_forest.python, tensorflow.examples.tutorials.mnist, tensorflow.python.ops, tensorflow
