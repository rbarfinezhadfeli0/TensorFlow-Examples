# Documentation: examples/2_BasicModels/linear_regression.py

## File Metadata

- **File Path**: `examples/2_BasicModels/linear_regression.py`
...
This file is located at `examples/2_BasicModels/linear_regression.py` within the TensorFlow Examples repository.
