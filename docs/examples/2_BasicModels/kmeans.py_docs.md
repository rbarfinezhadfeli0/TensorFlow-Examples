# Documentation: examples/2_BasicModels/kmeans.py

## File Metadata

- **File Path**: `examples/2_BasicModels/kmeans.py`
...
This file is located at `examples/2_BasicModels/kmeans.py` within the TensorFlow Examples repository.
...
```bash
python examples/2_BasicModels/kmeans.py
```
