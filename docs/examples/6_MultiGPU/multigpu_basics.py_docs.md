# Documentation: examples/6_MultiGPU/multigpu_basics.py

## File Metadata

- **File Path**: `examples/6_MultiGPU/multigpu_basics.py`
...
This file is located at `examples/6_MultiGPU/multigpu_basics.py` within the TensorFlow Examples repository.
...
```bash
python examples/6_MultiGPU/multigpu_basics.py
```
