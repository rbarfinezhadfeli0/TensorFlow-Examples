...
- [tensorflow_v1](doc.md): TensorFlow 1.x specific examples and code.
- [tensorflow_v2](../tensorflow_v2/doc.md): TensorFlow 2.x specific examples and code.
