# Documentation: tensorflow_v1/examples/3_NeuralNetworks/gan.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/3_NeuralNetworks/gan.py`
- **File Size**: 5655 bytes
- **File Type**: .py
...
This file is located at `tensorflow_v1/examples/3_NeuralNetworks/gan.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/3_NeuralNetworks/gan.py
```
...
training, glorot_init, relu, neural network, import, discriminator, mnist, tensorflow.examples.tutorials.mnist, __future__, division, loss, input_data, sigmoid, optimizer, numpy, dataset, gan, tensorflow, tensorflow, generator
