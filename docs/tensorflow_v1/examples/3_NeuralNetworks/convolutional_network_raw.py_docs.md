# Documentation: tensorflow_v1/examples/3_NeuralNetworks/convolutional_network_raw.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/3_NeuralNetworks/convolutional_network_raw.py`
...
This file is located at `tensorflow_v1/examples/3_NeuralNetworks/convolutional_network_raw.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/3_NeuralNetworks/convolutional_network_raw.py
```
