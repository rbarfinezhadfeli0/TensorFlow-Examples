# Documentation: tensorflow_v1/examples/3_NeuralNetworks/recurrent_network.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/3_NeuralNetworks/recurrent_network.py`
...
This file is located at `tensorflow_v1/examples/3_NeuralNetworks/recurrent_network.py` within the TensorFlow Examples repository.
...
This function handles RNN functionality.
...
```bash
python tensorflow_v1/examples/3_NeuralNetworks/recurrent_network.py
```
...
rnn, training, gradient, rnn, neural network, activation, accuracy, mnist, softmax, tensorflow.examples.tutorials.mnist, __future__, tensorflow.contrib, lstm, loss, input_data, optimizer, dataset, testing, print_function, tensorflow, tensorflow, RNN
