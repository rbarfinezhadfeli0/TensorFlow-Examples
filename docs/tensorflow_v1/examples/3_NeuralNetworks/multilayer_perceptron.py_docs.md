# Documentation: tensorflow_v1/examples/3_NeuralNetworks/multilayer_perceptron.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/3_NeuralNetworks/multilayer_perceptron.py`
...
This file is located at `tensorflow_v1/examples/3_NeuralNetworks/multilayer_perceptron.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/3_NeuralNetworks/multilayer_perceptron.py
```
