# Documentation: tensorflow_v1/examples/3_NeuralNetworks/dynamic_rnn.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/3_NeuralNetworks/dynamic_rnn.py`
...
This file is located at `tensorflow_v1/examples/3_NeuralNetworks/dynamic_rnn.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/3_NeuralNetworks/dynamic_rnn.py
```
