# Documentation: tensorflow_v1/examples/3_NeuralNetworks/dcgan.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/3_NeuralNetworks/dcgan.py`
...
This file is located at `tensorflow_v1/examples/3_NeuralNetworks/dcgan.py` within the TensorFlow Examples repository.
...
#### `generator(x, reuse=False)`

This function handles generator functionality.

#### `discriminator(x, reuse=False)`

This function handles discriminator functionality.
...
```bash
python tensorflow_v1/examples/3_NeuralNetworks/dcgan.py
```
...
training, neural network, convolution, import, pooling, discriminator, mnist, softmax, tensorflow.examples.tutorials.mnist, __future__, division, loss, input_data, sigmoid, optimizer, numpy, dataset, gan, tensorflow, tensorflow, generator
