# Documentation: tensorflow_v1/examples/3_NeuralNetworks/convolutional_network.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/3_NeuralNetworks/convolutional_network.py`
...
This file is located at `tensorflow_v1/examples/3_NeuralNetworks/convolutional_network.py` within the TensorFlow Examples repository.
...
#### `conv_net(x_dict, n_classes, dropout, reuse, is_training)`
...
```bash
python tensorflow_v1/examples/3_NeuralNetworks/convolutional_network.py
```
...
training, relu, neural network, convolution, pooling, activation, model_fn, accuracy, mnist, softmax, tensorflow.examples.tutorials.mnist, conv_net, __future__, division, prediction, loss, input_data, optimizer, testing, tensorflow, tensorflow
