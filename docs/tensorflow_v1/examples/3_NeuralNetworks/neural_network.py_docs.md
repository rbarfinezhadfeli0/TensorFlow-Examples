# Documentation: tensorflow_v1/examples/3_NeuralNetworks/neural_network.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/3_NeuralNetworks/neural_network.py`
...
This file is located at `tensorflow_v1/examples/3_NeuralNetworks/neural_network.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/3_NeuralNetworks/neural_network.py
```
