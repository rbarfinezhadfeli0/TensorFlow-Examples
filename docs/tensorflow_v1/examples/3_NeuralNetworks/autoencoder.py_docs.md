# Documentation: tensorflow_v1/examples/3_NeuralNetworks/autoencoder.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/3_NeuralNetworks/autoencoder.py`
...
This file is located at `tensorflow_v1/examples/3_NeuralNetworks/autoencoder.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/3_NeuralNetworks/autoencoder.py
```
