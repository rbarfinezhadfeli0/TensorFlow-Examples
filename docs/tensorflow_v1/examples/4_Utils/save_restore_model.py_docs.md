# Documentation: tensorflow_v1/examples/4_Utils/save_restore_model.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/4_Utils/save_restore_model.py`
...
This file is located at `tensorflow_v1/examples/4_Utils/save_restore_model.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/4_Utils/save_restore_model.py
```
