# Documentation: tensorflow_v1/examples/4_Utils/tensorboard_advanced.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/4_Utils/tensorboard_advanced.py`
...
This file is located at `tensorflow_v1/examples/4_Utils/tensorboard_advanced.py` within the TensorFlow Examples repository.
...
Located in the `tensorflow_v1/` directory, specifically within `tensorflow_v1/examples/4_Utils/`, this file is part of the TensorFlow 1.x examples collection.
...
```bash
python tensorflow_v1/examples/4_Utils/tensorboard_advanced.py
```
...
- [save_restore_model.py](save_restore_model.py_docs.md)
...
activation, __future__, training, multilayer_perceptron, gradient, relu, accuracy, loss, mnist, print_function, tensorflow, input_data, tensorflow.examples.tutorials.mnist, tensorflow, optimizer, softmax
