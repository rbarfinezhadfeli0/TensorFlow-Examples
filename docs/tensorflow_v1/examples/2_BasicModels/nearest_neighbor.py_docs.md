# Documentation: tensorflow_v1/examples/2_BasicModels/nearest_neighbor.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/2_BasicModels/nearest_neighbor.py`
...
This file is located at `tensorflow_v1/examples/2_BasicModels/nearest_neighbor.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/2_BasicModels/nearest_neighbor.py
```
