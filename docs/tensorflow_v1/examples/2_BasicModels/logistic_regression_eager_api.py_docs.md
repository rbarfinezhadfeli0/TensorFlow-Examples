# Documentation: tensorflow_v1/examples/2_BasicModels/logistic_regression_eager_api.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/2_BasicModels/logistic_regression_eager_api.py`
...
This file is located at `tensorflow_v1/examples/2_BasicModels/logistic_regression_eager_api.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/2_BasicModels/logistic_regression_eager_api.py
```
