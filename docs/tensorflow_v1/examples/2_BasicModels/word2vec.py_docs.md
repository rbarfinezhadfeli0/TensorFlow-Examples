# Documentation: tensorflow_v1/examples/2_BasicModels/word2vec.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/2_BasicModels/word2vec.py`
...
This file is located at `tensorflow_v1/examples/2_BasicModels/word2vec.py` within the TensorFlow Examples repository.
...
#### `next_batch(batch_size, num_skips, skip_window)`

This function handles next batch functionality.
...
```bash
python tensorflow_v1/examples/2_BasicModels/word2vec.py
```
...
os, __future__, training, testing, dataset, division, gradient, embedding, random, loss, import, urllib, tensorflow, tensorflow, zipfile, next_batch, optimizer, numpy
