# Documentation: tensorflow_v1/examples/2_BasicModels/gradient_boosted_decision_tree.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/2_BasicModels/gradient_boosted_decision_tree.py`
...
This file is located at `tensorflow_v1/examples/2_BasicModels/gradient_boosted_decision_tree.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/2_BasicModels/gradient_boosted_decision_tree.py
```
