# Documentation: tensorflow_v1/examples/2_BasicModels/linear_regression.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/2_BasicModels/linear_regression.py`
...
This file is located at `tensorflow_v1/examples/2_BasicModels/linear_regression.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/2_BasicModels/linear_regression.py
```
...
__future__, training, testing, regression, gradient, loss, print_function, tensorflow, tensorflow, matplotlib.pyplot, optimizer, numpy
