# Documentation: tensorflow_v1/examples/5_DataManagement/build_an_image_dataset.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/5_DataManagement/build_an_image_dataset.py`
...
This file is located at `tensorflow_v1/examples/5_DataManagement/build_an_image_dataset.py` within the TensorFlow Examples repository.
...
Located in the `tensorflow_v1/` directory, specifically within `tensorflow_v1/examples/5_DataManagement/`, this file is part of the TensorFlow 1.x examples collection.
...
This class provides functionality for id operations.

### Functions and Methods

#### `read_images(dataset_path, mode, batch_size)`

This function handles read images functionality.
...
```bash
python tensorflow_v1/examples/5_DataManagement/build_an_image_dataset.py
```
...
- [tensorflow_dataset_api.py](tensorflow_dataset_api.py_docs.md)
...
training, read_images, relu, convolution, pooling, activation, os, accuracy, softmax, conv_net, __future__, prediction, loss, ID, optimizer, dataset, testing, print_function, tensorflow, tensorflow, cnn
