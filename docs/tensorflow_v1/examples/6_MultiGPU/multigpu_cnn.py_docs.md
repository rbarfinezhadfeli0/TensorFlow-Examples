# Documentation: tensorflow_v1/examples/6_MultiGPU/multigpu_cnn.py

## File Metadata

- **File Path**: `tensorflow_v1/examples/6_MultiGPU/multigpu_cnn.py`
...
This file is located at `tensorflow_v1/examples/6_MultiGPU/multigpu_cnn.py` within the TensorFlow Examples repository.
...
```bash
python tensorflow_v1/examples/6_MultiGPU/multigpu_cnn.py
```
