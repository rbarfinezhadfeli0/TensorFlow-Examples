# Documentation: tensorflow_v1/notebooks/4_Utils/save_restore_model.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/4_Utils/save_restore_model.ipynb`
...
This file is located at `tensorflow_v1/notebooks/4_Utils/save_restore_model.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/4_Utils/save_restore_model.ipynb
```
