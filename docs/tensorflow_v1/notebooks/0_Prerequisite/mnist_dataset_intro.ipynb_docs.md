# Documentation: tensorflow_v1/notebooks/0_Prerequisite/mnist_dataset_intro.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/0_Prerequisite/mnist_dataset_intro.ipynb`
...
This file is located at `tensorflow_v1/notebooks/0_Prerequisite/mnist_dataset_intro.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/0_Prerequisite/mnist_dataset_intro.ipynb
```
