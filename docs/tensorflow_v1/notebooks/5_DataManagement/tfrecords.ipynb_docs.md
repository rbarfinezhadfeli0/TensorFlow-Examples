# Documentation: tensorflow_v1/notebooks/5_DataManagement/tfrecords.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/5_DataManagement/tfrecords.ipynb`
...
This file is located at `tensorflow_v1/notebooks/5_DataManagement/tfrecords.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/5_DataManagement/tfrecords.ipynb
```
