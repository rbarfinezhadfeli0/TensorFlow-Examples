# Documentation: tensorflow_v1/notebooks/5_DataManagement/build_an_image_dataset.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/5_DataManagement/build_an_image_dataset.ipynb`
...
This file is located at `tensorflow_v1/notebooks/5_DataManagement/build_an_image_dataset.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/5_DataManagement/build_an_image_dataset.ipynb
```
