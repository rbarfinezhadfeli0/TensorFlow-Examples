# Documentation: tensorflow_v1/notebooks/2_BasicModels/kmeans.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/2_BasicModels/kmeans.ipynb`
...
This file is located at `tensorflow_v1/notebooks/2_BasicModels/kmeans.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/2_BasicModels/kmeans.ipynb
```
...
training, testing, embedding, accuracy, mnist, tensorflow
