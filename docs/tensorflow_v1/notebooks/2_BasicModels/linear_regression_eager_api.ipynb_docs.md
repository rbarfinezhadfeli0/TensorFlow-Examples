# Documentation: tensorflow_v1/notebooks/2_BasicModels/linear_regression_eager_api.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/2_BasicModels/linear_regression_eager_api.ipynb`
...
This file is located at `tensorflow_v1/notebooks/2_BasicModels/linear_regression_eager_api.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/2_BasicModels/linear_regression_eager_api.ipynb
```
