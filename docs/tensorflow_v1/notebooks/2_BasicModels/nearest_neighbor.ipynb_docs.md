# Documentation: tensorflow_v1/notebooks/2_BasicModels/nearest_neighbor.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/2_BasicModels/nearest_neighbor.ipynb`
...
This file is located at `tensorflow_v1/notebooks/2_BasicModels/nearest_neighbor.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/2_BasicModels/nearest_neighbor.ipynb
```
...
training, testing, accuracy, mnist, tensorflow
