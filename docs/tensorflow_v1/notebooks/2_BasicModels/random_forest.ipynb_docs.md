# Documentation: tensorflow_v1/notebooks/2_BasicModels/random_forest.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/2_BasicModels/random_forest.ipynb`
...
This file is located at `tensorflow_v1/notebooks/2_BasicModels/random_forest.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/2_BasicModels/random_forest.ipynb
```
...
training, regression, accuracy, loss, mnist, tensorflow
