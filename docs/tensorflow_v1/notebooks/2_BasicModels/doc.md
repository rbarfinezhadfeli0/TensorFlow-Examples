# Documentation: tensorflow_v1/notebooks/2_BasicModels
...
- [gradient_boosted_decision_tree.ipynb](./gradient_boosted_decision_tree.ipynb_docs.md): Jupyter notebook with interactive code examples
- [kmeans.ipynb](./kmeans.ipynb_docs.md): Jupyter notebook with interactive code examples
- [linear_regression.ipynb](./linear_regression.ipynb_docs.md): Jupyter notebook with interactive code examples
- [linear_regression_eager_api.ipynb](./linear_regression_eager_api.ipynb_docs.md): Jupyter notebook with interactive code examples
- [logistic_regression.ipynb](./logistic_regression.ipynb_docs.md): Jupyter notebook with interactive code examples
...
- [tensorflow_v1/notebooks/0_Prerequisite](../0_Prerequisite/doc.md): TensorFlow 1.x specific examples and code.
- [tensorflow_v1/notebooks/1_Introduction](../1_Introduction/doc.md): Introductory examples for getting started with TensorFlow.
- [tensorflow_v1/notebooks/3_NeuralNetworks](../3_NeuralNetworks/doc.md): Neural network implementations including CNNs, RNNs, GANs, and autoencoders.
- [tensorflow_v1/notebooks/4_Utils](../4_Utils/doc.md): Utility code for model saving, TensorBoard integration, and other helper functionality.
- [tensorflow_v1/notebooks/5_DataManagement](../5_DataManagement/doc.md): Data loading, preprocessing, and augmentation examples.
