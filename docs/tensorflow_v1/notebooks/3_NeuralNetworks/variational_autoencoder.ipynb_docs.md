# Documentation: tensorflow_v1/notebooks/3_NeuralNetworks/variational_autoencoder.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/3_NeuralNetworks/variational_autoencoder.ipynb`
...
This file is located at `tensorflow_v1/notebooks/3_NeuralNetworks/variational_autoencoder.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/3_NeuralNetworks/variational_autoencoder.ipynb
```
