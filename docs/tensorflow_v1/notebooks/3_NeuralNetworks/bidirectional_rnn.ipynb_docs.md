# Documentation: tensorflow_v1/notebooks/3_NeuralNetworks/bidirectional_rnn.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/3_NeuralNetworks/bidirectional_rnn.ipynb`
- **File Size**: 11956 bytes
- **File Type**: .ipynb
...
This file is located at `tensorflow_v1/notebooks/3_NeuralNetworks/bidirectional_rnn.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/3_NeuralNetworks/bidirectional_rnn.ipynb
```
