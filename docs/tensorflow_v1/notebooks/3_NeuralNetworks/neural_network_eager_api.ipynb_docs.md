# Documentation: tensorflow_v1/notebooks/3_NeuralNetworks/neural_network_eager_api.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/3_NeuralNetworks/neural_network_eager_api.ipynb`
- **File Size**: 8838 bytes
- **File Type**: .ipynb
...
This file is located at `tensorflow_v1/notebooks/3_NeuralNetworks/neural_network_eager_api.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/3_NeuralNetworks/neural_network_eager_api.ipynb
```
...
activation, dataset, training, testing, gradient, relu, neural network, accuracy, loss, mnist, softmax, tensorflow, optimizer
