# Documentation: tensorflow_v1/notebooks/3_NeuralNetworks/dcgan.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/3_NeuralNetworks/dcgan.ipynb`
...
This file is located at `tensorflow_v1/notebooks/3_NeuralNetworks/dcgan.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/3_NeuralNetworks/dcgan.ipynb
```
