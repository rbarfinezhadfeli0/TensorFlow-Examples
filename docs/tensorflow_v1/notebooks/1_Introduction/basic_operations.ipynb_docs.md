# Documentation: tensorflow_v1/notebooks/1_Introduction/basic_operations.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/1_Introduction/basic_operations.ipynb`
...
This file is located at `tensorflow_v1/notebooks/1_Introduction/basic_operations.ipynb` within the TensorFlow Examples repository.
...
Located in the `tensorflow_v1/` directory, specifically within `tensorflow_v1/notebooks/1_Introduction/`, this file is part of the TensorFlow 1.x examples collection.
...
```bash
jupyter notebook tensorflow_v1/notebooks/1_Introduction/basic_operations.ipynb
```
