# Documentation: tensorflow_v1/notebooks/6_MultiGPU/multigpu_basics.ipynb

## File Metadata

- **File Path**: `tensorflow_v1/notebooks/6_MultiGPU/multigpu_basics.ipynb`
...
This file is located at `tensorflow_v1/notebooks/6_MultiGPU/multigpu_basics.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook tensorflow_v1/notebooks/6_MultiGPU/multigpu_basics.ipynb
```
