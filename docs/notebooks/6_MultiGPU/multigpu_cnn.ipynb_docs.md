# Documentation: notebooks/6_MultiGPU/multigpu_cnn.ipynb

## File Metadata

- **File Path**: `notebooks/6_MultiGPU/multigpu_cnn.ipynb`
...
This file is located at `notebooks/6_MultiGPU/multigpu_cnn.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/6_MultiGPU/multigpu_cnn.ipynb
```
