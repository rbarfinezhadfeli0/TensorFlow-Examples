# Documentation: notebooks/4_Utils
...
- [save_restore_model.ipynb](./save_restore_model.ipynb_docs.md): Jupyter notebook with interactive code examples
- [tensorboard_advanced.ipynb](./tensorboard_advanced.ipynb_docs.md): Jupyter notebook with interactive code examples
- [tensorboard_basic.ipynb](./tensorboard_basic.ipynb_docs.md): Jupyter notebook with interactive code examples
