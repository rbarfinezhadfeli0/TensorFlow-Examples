# Documentation: notebooks/4_Utils/save_restore_model.ipynb

## File Metadata

- **File Path**: `notebooks/4_Utils/save_restore_model.ipynb`
- **File Size**: 8471 bytes
- **File Type**: .ipynb
...
This file is located at `notebooks/4_Utils/save_restore_model.ipynb` within the TensorFlow Examples repository.
...
Located in the `notebooks/` directory, specifically within `notebooks/4_Utils/`, this file is part of the notebook-based tutorials.
...
```bash
jupyter notebook notebooks/4_Utils/save_restore_model.ipynb
```
...
activation, training, relu, accuracy, loss, mnist, softmax, tensorflow, optimizer
