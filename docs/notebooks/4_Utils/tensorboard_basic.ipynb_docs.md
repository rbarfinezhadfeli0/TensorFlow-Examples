# Documentation: notebooks/4_Utils/tensorboard_basic.ipynb

## File Metadata

- **File Path**: `notebooks/4_Utils/tensorboard_basic.ipynb`
...
This file is located at `notebooks/4_Utils/tensorboard_basic.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/4_Utils/tensorboard_basic.ipynb
```
