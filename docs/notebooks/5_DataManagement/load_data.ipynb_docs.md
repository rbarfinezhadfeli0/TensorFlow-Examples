# Documentation: notebooks/5_DataManagement/load_data.ipynb

## File Metadata

- **File Path**: `notebooks/5_DataManagement/load_data.ipynb`
...
This file is located at `notebooks/5_DataManagement/load_data.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/5_DataManagement/load_data.ipynb
```
