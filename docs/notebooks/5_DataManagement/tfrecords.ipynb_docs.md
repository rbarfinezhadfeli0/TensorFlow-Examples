# Documentation: notebooks/5_DataManagement/tfrecords.ipynb

## File Metadata

- **File Path**: `notebooks/5_DataManagement/tfrecords.ipynb`
...
This file is located at `notebooks/5_DataManagement/tfrecords.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/5_DataManagement/tfrecords.ipynb
```
