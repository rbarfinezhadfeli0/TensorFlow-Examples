# Keyword Map: notebooks/5_DataManagement/load_data.ipynb

## File Path and Links

- **Original Source**: [notebooks/5_DataManagement/load_data.ipynb](../../../notebooks/5_DataManagement/load_data.ipynb)
- **Documentation**: [notebooks/5_DataManagement/load_data.ipynb_docs.md](load_data.ipynb_docs.md)
...
- **File**: [notebooks/5_DataManagement/load_data.ipynb](../../../notebooks/5_DataManagement/load_data.ipynb)
- **Documentation**: [notebooks/5_DataManagement/load_data.ipynb_docs.md](load_data.ipynb_docs.md)
