# Documentation: notebooks/5_DataManagement/image_transformation.ipynb

## File Metadata

- **File Path**: `notebooks/5_DataManagement/image_transformation.ipynb`
...
This file is located at `notebooks/5_DataManagement/image_transformation.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/5_DataManagement/image_transformation.ipynb
```
