# Documentation: notebooks/5_DataManagement/build_an_image_dataset.ipynb

## File Metadata

- **File Path**: `notebooks/5_DataManagement/build_an_image_dataset.ipynb`
- **File Size**: 10553 bytes
- **File Type**: .ipynb
...
This file is located at `notebooks/5_DataManagement/build_an_image_dataset.ipynb` within the TensorFlow Examples repository.
...
Located in the `notebooks/` directory, specifically within `notebooks/5_DataManagement/`, this file is part of the notebook-based tutorials.
...
```bash
jupyter notebook notebooks/5_DataManagement/build_an_image_dataset.ipynb
```
...
activation, dataset, training, testing, relu, accuracy, convolution, loss, softmax, tensorflow, optimizer, pooling, cnn
