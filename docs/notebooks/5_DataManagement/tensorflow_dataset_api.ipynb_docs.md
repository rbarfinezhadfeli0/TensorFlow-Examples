# Documentation: notebooks/5_DataManagement/tensorflow_dataset_api.ipynb

## File Metadata

- **File Path**: `notebooks/5_DataManagement/tensorflow_dataset_api.ipynb`
...
This file is located at `notebooks/5_DataManagement/tensorflow_dataset_api.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/5_DataManagement/tensorflow_dataset_api.ipynb
```
