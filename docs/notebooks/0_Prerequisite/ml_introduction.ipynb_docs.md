# Documentation: notebooks/0_Prerequisite/ml_introduction.ipynb

## File Metadata

- **File Path**: `notebooks/0_Prerequisite/ml_introduction.ipynb`
...
This file is located at `notebooks/0_Prerequisite/ml_introduction.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/0_Prerequisite/ml_introduction.ipynb
```
