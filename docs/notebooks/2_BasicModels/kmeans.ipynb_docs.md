# Documentation: notebooks/2_BasicModels/kmeans.ipynb

## File Metadata

- **File Path**: `notebooks/2_BasicModels/kmeans.ipynb`
...
This file is located at `notebooks/2_BasicModels/kmeans.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/2_BasicModels/kmeans.ipynb
```
