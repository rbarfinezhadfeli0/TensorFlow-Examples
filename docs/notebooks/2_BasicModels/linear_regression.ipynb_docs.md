# Documentation: notebooks/2_BasicModels/linear_regression.ipynb

## File Metadata

- **File Path**: `notebooks/2_BasicModels/linear_regression.ipynb`
...
This file is located at `notebooks/2_BasicModels/linear_regression.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/2_BasicModels/linear_regression.ipynb
```
