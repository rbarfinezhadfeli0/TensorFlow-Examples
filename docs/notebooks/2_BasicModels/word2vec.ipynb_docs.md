# Documentation: notebooks/2_BasicModels/word2vec.ipynb

## File Metadata

- **File Path**: `notebooks/2_BasicModels/word2vec.ipynb`
...
This file is located at `notebooks/2_BasicModels/word2vec.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/2_BasicModels/word2vec.ipynb
```
