# Documentation: notebooks/2_BasicModels/nearest_neighbor.ipynb

## File Metadata

- **File Path**: `notebooks/2_BasicModels/nearest_neighbor.ipynb`
...
This file is located at `notebooks/2_BasicModels/nearest_neighbor.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/2_BasicModels/nearest_neighbor.ipynb
```
