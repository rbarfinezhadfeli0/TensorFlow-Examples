# Documentation: notebooks/2_BasicModels/random_forest.ipynb

## File Metadata

- **File Path**: `notebooks/2_BasicModels/random_forest.ipynb`
...
This file is located at `notebooks/2_BasicModels/random_forest.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/2_BasicModels/random_forest.ipynb
```
