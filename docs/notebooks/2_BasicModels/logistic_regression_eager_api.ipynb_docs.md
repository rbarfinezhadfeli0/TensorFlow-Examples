# Documentation: notebooks/2_BasicModels/logistic_regression_eager_api.ipynb

## File Metadata

- **File Path**: `notebooks/2_BasicModels/logistic_regression_eager_api.ipynb`
...
This file is located at `notebooks/2_BasicModels/logistic_regression_eager_api.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/2_BasicModels/logistic_regression_eager_api.ipynb
```
