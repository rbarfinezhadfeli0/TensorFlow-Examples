# Documentation: notebooks/3_NeuralNetworks/neural_network_raw.ipynb

## File Metadata

- **File Path**: `notebooks/3_NeuralNetworks/neural_network_raw.ipynb`
...
This file is located at `notebooks/3_NeuralNetworks/neural_network_raw.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/3_NeuralNetworks/neural_network_raw.ipynb
```
