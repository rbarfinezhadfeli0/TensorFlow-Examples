# Documentation: notebooks/3_NeuralNetworks/autoencoder.ipynb

## File Metadata

- **File Path**: `notebooks/3_NeuralNetworks/autoencoder.ipynb`
...
This file is located at `notebooks/3_NeuralNetworks/autoencoder.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/3_NeuralNetworks/autoencoder.ipynb
```
