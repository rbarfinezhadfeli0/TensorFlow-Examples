# Documentation: notebooks/3_NeuralNetworks/convolutional_network.ipynb

## File Metadata

- **File Path**: `notebooks/3_NeuralNetworks/convolutional_network.ipynb`
...
This file is located at `notebooks/3_NeuralNetworks/convolutional_network.ipynb` within the TensorFlow Examples repository.
...
```bash
jupyter notebook notebooks/3_NeuralNetworks/convolutional_network.ipynb
```
